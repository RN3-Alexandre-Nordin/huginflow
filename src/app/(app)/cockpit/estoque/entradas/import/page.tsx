...
import ImportPlanilhaForm from './ImportPlanilhaForm'

export const metadata = { title: 'Importar Planilha de Entrada | HuginFlow' }

export default async function ImportarEntradaPlanilhaPage() {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in duration-700">
        ...
        <p className="text-gray-400 max-w-md mx-auto mb-8 text-lg">
          Seu grupo de acesso não possui permissão para importar planilhas de entrada de estoque.
        </p>
    ...
    <div className="space-y-6 pb-20 font-sans">
      ...
      <div>
        <h1 className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
          ...
          Importação de Entrada via Planilha (Canal B)
        </h1>
        <p className="text-xs text-gray-400 mt-0.5">
          Envie ou cole arquivo CSV pré-formatado com validação item a item antes da efetivação no estoque.
        </p>
      </div>
