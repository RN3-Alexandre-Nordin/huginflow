...
export const metadata = { title: 'Lote de Retirada | HuginFlow' }

interface PageProps {
  params: Promise<{ id: string }>
}

export default async function RetiradaLoteDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-4 pb-20 font-sans">
      ...
      <BackTextButton
        fallbackHref="/cockpit/estoque/retiradas"
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">Lote de retirada manual</p>
        </div>
